...
#   Character.create(name: 'Luke', movie: movies.first)
  ...
  mule_two.save!
  offer = Offer.new( destination: "Miami", starting_point: "Kaboul", distance: 12500, drug_type: "opium", weight: 20, commission: 500000 )
  offer.user = user
  offer.mule = mule
  offer.save!
  offer_2 = Offer.new( destination: "Berlin", starting_point: "Chez DavidetBene Rennes", distance: 1174, drug_type: "Ecstasy", weight: 10, commission: 11740)
